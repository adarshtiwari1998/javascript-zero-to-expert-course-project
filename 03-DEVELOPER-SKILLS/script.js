...
const x = '23'; // automatically changed my double quotes "" back to single quote ''/ So that't the thing we need to configure by rewriting the prettier object in .prettierrc file.
