...
//////////////// CONDITIONAL OR TERNARY OPERATOR CODING CHALLENGE
...
// number 1
const tip = bill <= 300 && bill >= 50  ? bill * 0.15 : bill * 0.2;  // conditional operator  output in console is if the bill is less then or equal to 300 and greater than and equal to 50 so then if block is executed so therfore the first part of ternary operator will be executed and become the result of this operator essentially. So the result of this operator will be bill times 0.15 and that's the value that will be assigned  to the tip variable.
